...
$ repo init -u https://github.com/SonyAosp/platform_manifest -b android-10.0
```
...
```bash
# install `git-lfs` (more info [here](https://git-lfs.github.com/)) since OpenGapps is now using it
# after install git-lfs do
